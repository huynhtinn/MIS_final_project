        ...
        <div class="container">
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.5s">
                <div class="testimonial-item p-4 p-lg-5">
                    <p class="mb-4">You can taste the care in every coffee brew and the quality of their fresh juices.</p>
                ...
                <div class="testimonial-item p-4 p-lg-5">
                    <p class="mb-4">Fresh, fruity, and fabulous—describes both their coffee and juice selections.</p>
                    <div class="d-flex align-items-center justify-content-center">
                ...
                <div class="testimonial-item p-4 p-lg-5">
                    <p class="mb-4">Their green juice is so refreshing, and the espresso always gives me the energy I need!</p>
                    <div class="d-flex align-items-center justify-content-center">
                ...
                <div class="testimonial-item p-4 p-lg-5">
                    <p class="mb-4">Freshly Brewed is my happy place with delicious coffee and rejuvenating juices.</p>
                    <div class="d-flex align-items-center justify-content-center">
                        <img class="img-fluid flex-shrink-0" src="img/testimonial-3.jpg" alt="">
                        <div class="text-start ms-3">
                            <h5>Huynh Tin</h5>
