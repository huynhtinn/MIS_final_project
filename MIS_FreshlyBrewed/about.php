        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6">
                    <div class="row g-3">
                        <div class="col-6 text-end">
                            ...
                            <img class="img-fluid bg-white w-50 wow fadeIn" data-wow-delay="0.2s" src="img/about-9.jpg" alt="">
                        </div>
                        <div class="col-6">
                            <img class="img-fluid bg-white w-50 mb-3 wow fadeIn" data-wow-delay="0.3s" src="img/about-8.jpg" alt="">
                ...
                <div style="text-align: center; font-size: 20px;">
                    <p class="mb-0" style="font-size: 20px; font-style: italic;">
                        Established in 2024, FreshlyBrewed has made a lasting impression on customers in just 10 months of operation. 
                        We not only provide high-quality coffee but also create a comfortable, inviting space where customers can relax, 
                        work, socialize, and enjoy their time. With dedicated service and a unique atmosphere, FreshlyBrewed is committed 
                        to delivering an exceptional experience for all coffee enthusiasts.
                    </p>
                </div>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt text-primary me-3"></i>123 Street, HCMC, VietNam</p>
