...
<body>
                ...
                <div class="col-lg-4">
                    <div class="bg-light p-4">
                        ...
                        <div class="d-flex justify-content-between">
                            <h5>Subtotal</h5>
                            <h5 id="cart-subtotal">$0.00</h5>
                        </div>
                        <div class="d-flex justify-content-between">
                            <h5>Tax</h5>
                            <h5 id="cart-tax">$0.00</h5>
                        </div>
                        <div class="d-flex justify-content-between">
                            <h5>Total</h5>
                            <h5 id="cart-total">$0.00</h5>
                        </div>
                    <button class="btn btn-primary w-100 mt-3" onclick="window.location.href='checkout.html'">Proceed to Checkout</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        // Example JavaScript to handle cart items
        const cartItems = [
